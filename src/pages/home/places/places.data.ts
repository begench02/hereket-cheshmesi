...
export const places: Places[] = [
		...
		places: [
			{
				id: uuidv4(),
				name: 'Kow Ata',
				name_ru: 'Подземное озеро Коу Ата',
				img: KowAta,
				history:
	...
	},
	{
		...
		places: [
			...
			{
				id: uuidv4(),
				name: 'Lake Kainar Baba',
				name_ru: 'Озеро Кайнар баба',
				img: KaynarBaba,
				history:
	...
	},
	{
		...
		places: [
			...
			},
			{
				...
				img: Karakum,
				history:
					'The Karakum desert is a sandy desert, one of the largest in Central Asia, one of the largest on earth. It occupies almost 3/4 of the territory of the Republic of Turkmenistan. It is located between the foothills of Kopetdag, Karabil and Vankhyz in the south, the Khorezm lowland in the north, the Amu Darya valley in the east and the bed of the Western Uzboy in the west. The length of the Karakum along the parallel is about 800 km., along the meridian - about 450km, the total area is more than 350 thousand sq.km. It exceeds the territory of states such as Great Britain, Italy or Norway.',
				history_ru:
					'Каракумы – это песчаная пустыня, одна из самых больших в Центральной Азии, одна из крупных на земле. Она занимает почти 3/4 территории Республики Туркменистан. Расположена между предгорьями Копетдага, Карабиля и Ванхыза на юге, Хорезмской низменностью на севере, долиной Амударьи на востоке и руслом Западного Узбоя на западе. Протяженность Каракумов по параллели – около 800 км., по меридиану – около 450 км., общая площадь – более 350 тыс.км². Она превышает территорию таких государств, как Великобритания, Италия или Норвегия.',
			},
			{
				id: uuidv4(),
				name: 'Parau-bibi',
