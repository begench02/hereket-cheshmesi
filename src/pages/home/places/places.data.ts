		...
		places: [
			{
				...
				img: Berkarar,
				history:
					'The Berkarar shopping center is the largest shopping and entertainment center in Turkmenistan. The complex is located in the southern part of Ashgabat, at the intersection of 10 Yil-Abadanchylyk and Ataturk avenues. Built in 2014. The total area is 17.5 hectares. Next to the shopping and entertainment center there is also an adjacent 12-story round tower of the Berkarar business center',
				history_ru:
					'ТЦ «Беркарар» — крупнейший в Туркменистане торгово-развлекательный центр. Комплекс расположен в южной части Ашхабада, на пересечении проспектов 10 Йыл-Абаданчылык и Ататюрка. Построен в 2014 году]. Общая площадь составляет 17,5га. Рядом с торгово-развлекательным центром разместилась и смежная с ним 12-этажная круглая башня делового центра «Беркарар»',
			},
			{
				id: uuidv4(),
				...
				history:
					'Ertuğrul Gazi Mosque is one of the most beautiful mosques in Ashgabat, built in the Turkish style, and is the largest in the city. The mosque has four minarets. One of the first mosques built after Turkmenistan gained independence, in the early 1990s. Named after the Turkic ruler Ertogrul',
				history_ru:
			...
			},
			{
				...
				img: AltynAsyr,
				history:
					'Oriental bazaar Altyn Asyr (Turkmen: Altyn Asyr gündogar bazary) also known locally as Täze jygyldyk is the largest market in Turkmenistan, and the fifth-largest in Central Asia. It is located in the outskirts of Ashgabat, in the residential area Choganly. It was built to resemble the shape a Turkmen carpet ornament of Ahal Province. The market covers 154 hectares. At the heart of the bazaar is a tall clock tower, its main landmark. There are 2155 shops in the market',
				history_ru:
		...
		places: [
			{
				...
				img: KowAta,
				history:
					'One of the most famous and visited tourist sites in Turkmenistan. The Baharden Cave is a 250-meter hall, the height of which decreases from 26 meters at the entrance to 3 meters near the lake itself, located at a depth of 55 meters. Air temperature is 20-25°C in winter and 27-32°C in summer. And the water temperature is 37 °C. The underground lake is considered healing because its water is rich in hydrogen sulfide and 26 other chemical elements. Archaeologists claim that the cave has been visited by people for more than 2000 years. Today it is equipped with a concrete descent, an observation deck and lighting. This negatively impacted the bat colony. Of more than 400 thousand individuals, only a few tens of thousands remain',
				history_ru:
			...
			},
			{
				...
				img: GeokTepe,
				history:
					'Located 40 km. west of Ashgabat. The famous Battle of Geok-Tepe took place on the territory of the fortress. The siege of the fortress passed under the command of the Russian general Mikhail Dmitrievich Skobelev. The Turkmens were led by Nurberdi Khan and his son Magtymguly Khan. Today, on the territory of the fortress, one of the most beautiful mosques and an open museum dedicated to the bloody battle of Geok-Tepe have been built. At the entrance to the city, a few kilometers away, rise slender 60-meter minarets and the turquoise dome of the Geok-Tepe Mosque, 40 meters high.The Geok-Tepe fortress was built by the French company Bouygues. The Geok-Tepe fortress is a significant spectacle that played a corresponding role in the history of Turkmenistan. It became the last bastion on the path of Tsarist Russia in the conquest of Central Asia',
				history_ru:
					'Расположен в 40 км. к западу от Ашгабада. На территории крепости произошла знаменитая Гёктепинская битва. Осада крепости проходила под командованием русского генерала Михаила Дмитриевича Скобелева. Во главе туркменов стояли Нурберди Хан и его сын Махтумкули Хан. Сегодня на территории крепости построена одна из красивейших мечетей и открытый музей, посвященный кровопролитной битве при Гёкдепе. При подъезде к городу, за несколько километров, возвышаются стройные 60-метровые минареты и бирюзовый купол Гёктепинской мечети высотой 40 метров. Крепость Гёкдепе была построена французкой компанией Буиг. Крепость Гёкдепе является знаменательным зрелищем, сыгравшим в истории Туркменистана соответствующую роль. Она стала последним бастионом на пути Царской России в завоевании Средней Азии',
			},
			{
				id: uuidv4(),
				...
				history:
					'The ruins of Abiverd are located halfway between Ashgabat and Mary. In ancient times, Abiverd (it went down in history under different names - Baverd, Abaverd, Paart, Pavart, Peshtak) was one of the major centers of Northern Khorasan, repeatedly mentioned in written sources as “... a city with fertile land and rich harvests, famous for its lush bazaar and mosque." At that time, Abiverd was an impregnable fortress, saving towns people from the attacks of nomads. The fortress had a single gate from the southwest. Inside, in the center, there was a mosque building, erected at the beginning of the 15th century, and a square was located not far from it. Starting from the reign of Caliph Osman in 652. Abiverd becomes a “bone of discord” between various Arab caliphs. During the reign of the Abbasids, Abiverd was subordinate to Khorasan. At one time, Abiverdwas ruled by such high-profile dynasties as the Tahirids, Saffarids, and Samanids. In the 12th century Abiverd fell under the invasion of the Mongols. The eldest son of Genghis Khan, Tulikhan, literally razed the flourishing city, surrounded by powerful fortress walls, to the ground.',
				history_ru:
					'Развалины Абиверда находятся на середине пути между Ашхабадом и Мары. В древности Абиверд (в историю он вошел под разными названиями – Баверд, Абаверд, Паарт, Паварт, Пештак) был одним из крупных центров Северного Хорасана, неоднократно упоминаемый в письменных источниках как «…город с плодородной землей и богатыми урожаями, славящийся пышным базаром и мечетью». В то время Абиверд представлял собой неприступную крепость, спасших горожан от набегов кочевников. Крепость имела единственные ворота с юго-запада. Внутри, в центре, стояло здание мечети, воздвигнутое в начале XV в., неподалеку от нее располагалась площадь. Начиная со времени правления халифа Османа в 652г. Абиверд становится «яблоком раздора» между различными арабскими халифами. Во время правления Аббасидов Абиверд находился в подчинении у Хорасана. В свое время Абивердом правили такие громкие династии как Тахириды, Саффариды, Саманиды. В XIIв. Абиверд пал под нашествием монголов. Старший сын Чингизхана – Тулихан - буквально сравнял цветущий, окруженный мощными крепостными стенами, город с землей',
			},
			{
				id: uuidv4(),
				name: 'Nisa',
			...
			},
			{
				...
				history:
					'Meana-baba erected over the ashes of the famous Muslim religious figure of the Middle Ages, Sheikh Abulsagyt Abulhaira, who lived in the 10th - 11th centuries. The mausoleum is located approximately 40 km southeast of the village of Dushak, Ahal region of Turkmenistan and 200 km southeast of Ashgabat. The mausoleum was built in the 11th century, and in the 14th century major reconstruction work was carried out on it',
				history_ru:
					'Меана-баба воздвигнутый над прахом известного мусульманского религиозного деятеля средневековья шейха Абулсагыта Абулхайры, жившего в X - XI в.в. Мавзолей расположен примерно в 40 км юго-восточнее поселка Душак, Ахалского велаята Туркменистана и в 200 км юго-восточнее Ашхабата. Мавзолей был построен в XI веке, а в XIV веке на нем были выполнены работы по капитальной реконструкции',
			},
			{
				id: uuidv4(),
				...
				history:
					'The Seyit Dzhemal ad-Din Mosque is the ruins of a grandiose mosque in Turkmenistan, in the foothills of the Kopet Dag, on the territory of the medieval settlement of Anau, east of the modern city of Anau, the administrative center of the Ahal region, 12 kilometers east of Ashgabat. Monument of medieval architecture of Central Asia. Built in 1446-1457 in honor of Sheikh Jalal ad-Dunya-va-d-din. The mosaic decoration of the mosque has no analogues in the Muslim architecture of Central Asia. On the arch were depicted two azhdarch dragons with their heads facing each other. The monument is visited by tourists interested in history and culture, and the saint’s grave near the Anau mosque is a place of pilgrimage. Was destroyed by the Ashgabat earthquake in 1948.',
				history_ru:
					'Мечеть Сейит Джемал ад-Дина — развалины грандиозной мечети в Туркменистане, в предгорьях Копетдага, к востоку от современного города Аннау, административного центра Ахалского велаята, в 12 километрах к востоку от Ашхабада. Памятник средневековой архитектуры Центральной Азии. Построена в 1446—1457 годах в честь шейха Джелал-ад-дунья-ва-д-дина. Мозаичная декорация мечети не имеет аналогов в мусульманской архитектуре Средней Азии. На арке были изображены два обращённых головами друг к другу дракона-аждарха. Памятник посещают туристы, увлекающиеся историей и культурой, а могила святого возле мечети Анау является местом паломничества. Была Разрушена Ашхабадским землетрясением в 1948 году.',
			},
			{
				id: uuidv4(),
				name: 'Altyn tepe',
	...
	},
	{
		...
		places: [
			...
			// },
			{
				...
				img: SoltanSanjar,
				history:
					'The most majestic architectural monument of Merv is the mausoleum of Sultan Sanjar called “Dar-al-Ahyre” (“Otherworld”). Its entire appearance reflects the highest achievements and flourishing of the Seljukid power. The mausoleum of Sultan Sanjar is located in the center of the city of Sultan Kala. Nearby are large monumental buildings - palaces of Seljukid rulers and a mosque. The walls are 5 meters thick at the base. In length the walls of the mausoleum stretched for 27 meters. The total height of the mausoleum is 38 meters',
				history_ru:
					'Самым величественным архитектурным памятником Мерва является мавзолей султана Санджара под названием «Дар-ал-Ахыре» («Потусторонний мир»). Всем своим видом он отражает наивысшие достижения и расцвет державы Сельджукидов. Мавзолей султана Санджара расположен в центре города Султан-Кала. Поблизости находятся крупные монументальные здания — дворцы сельджукидских правителей и мечеть. Стены в толщину у основания - 5 м. В длину стены мавзолея протянулись на 27 метров. Общая высота мавзолея составляет 38 м.',
			},
			{
				id: uuidv4(),
				name: 'Gonur Depe',
				...
				img: GonurDepe,
				history:
					'Not so long ago, in the 90s, among the sands of the eastern Karakum, archaeological scientists discovered a huge necropolis in the Mary oasis dating back to the II-I millennium BC. There was a capital city here, now called Gonur-Depe (translated from Turkmen as Gray Hill), with its own palace and several temples that could compete with the buildings of Assyria and Babylon. Excavations of this place brought scientists and historians many amazing discoveries. The temple city kept its secrets in the desert sands for several millennia. Gonur-Depe was the largest settlement in all of Margiana. The complex was located on a low hill on the right bank of the Murghab river. Excavations are still ongoing, and there are no exact figures yet, but according to preliminary data, the area of the ancient settlement ranges from 30 to 50 hectares. In this supposed “capital” there was not a ruler with certain powers who ruled the entire country, but rather a spiritual leader - a high priest. People revered him not out of coercion, but out of their own free will, driven by faith',
				history_ru:
					'Не так давно, в 90-х годах, среди песков восточного Каракума ученые-археологи вскрыли в Марыйском оазисе огромный некрополь, относящийся к II-I тыс. до н.э. Здесь был столичный город, ныне именуемый Гонур-Депе (в переводе с туркменского — Серый холм), со своим дворцом и несколькими храмами, способными конкурировать с сооружениями Ассирии и Вавилона. Раскопки этого места принесли ученым и историкам немало удивительных открытий. Храмовый город хранил свои тайны в песках пустыни несколько тысячелетий. Гонур-Депе был самым крупным поселением во всей Маргиане. Располагался комплекс на невысоком холме правого берега реки Мургаба. Раскопки ведутся до сих пор, и точных цифр пока нет, но по предварительным данным площадь древнего города колеблется от 30 до 50 гектаров. В этой предполагаемой «столице» находился скорее не правитель с определенными властными полномочиями, управлявший всей страной, а духовный лидер - верховный жрец. Люди почитали его не по принуждению, а по доброй воле, движимые верой',
			},
			{
				id: uuidv4(),
	...
	},
	{
		...
		places: [
			...
			},
			{
				...
				img: KapKutan,
				history:
					'The Cap-Kutan cave is located in the southeast of Turkmenistan, on the slope of the Kugitangtau ridge (the southwestern spur of the Gissar ridge). The ridge stretches from south to north, gradually rising from 1000 to 3000m. Stratigraphically above the limestones lie gypsum and anhydrites of the Gaurdak formation, which are preserved fragmentarily in the form of remains only at the foot of the southern part of the ridge',
				history_ru:
					'Пещера Кап-Кутан располагается на юго-востоке Туркменистана, на склоне хребта Кугитангтау (юго-западный отрог Гиссарского хребта). Хребет вытянут с юга на север, постепенно повышаясь с 1000 до 3000 м. Стратиграфически выше известняков залегают гипсы и ангидриты гаурдакской свиты, которые сохранились фрагментарно в виде останков только у подножья южной части хребта',
			},
			{
				id: uuidv4(),
	...
	},
	{
		...
		places: [
			...
			},
			{
				...
				history:
					'Mausoleum of Tyurabek-Khanym is a medieval mausoleum located on the territory of the Kone-Urgench National Historical and Cultural Museum-Reserve in the city of Kone-Urgench, Turkmenistan. The mausoleum was built in honor of Tyurabek Khanum, who was the daughter of the Golden Horde khan Uzbek Khan and the wife of his Khorezm governor from the Kungrat family Kutlug-Timur, which later became the tomb of the Sufi-Kungrat dynasty (1359-1388)',
				history_ru:
					'Мавзолей Тюрабек-Ханым — средневековый мавзолей, расположенный на территории Кёнеургенчского национального историко-культурного музея-заповедника в г.Кёнеургенч, Туркменистан. Мавзолей построен в честь Тюрабек-Ханым, которая была дочерью хана Золотой Орды Узбек-Хана и женой его Хорезмийского наместника из рода Кунграт Кутлуг-Тимура, позже ставший гробницей династии Суфи-Кунгратов(1359—1388)',
			},
			{
				id: uuidv4(),
				...
				history:
					'Il-Arslan (fullname - Taj ad-Dunya wa ad-Din Abul-Fath Il-Arslan ibn Atsiz; died March 7, 1172) - Khorezmshah, son of Khorezmshah Ala ad-Din Atsyz from the Anushtegenid dynasty. Reigned from 1156 to 1172. The nickname Il Arslan, translated from Turkic, means lion of the people. In 1152, Il-Arslan became the ruler of the city of Jenda, conquered by his father in the lower reaches of the Syr Darya. In 1156, after the death of Shah Atsiz, Il-Arslan ascended the throne of Khorezm. Like his father, he did not pay tribute to the Seljuk Sultan Sanjar and the Karakitays. Just a few months after Il-Arslan came to power, in 1157, Sanjar died, which allowed Khorezm to be completely freed from Seljuk influence. Inthe 1160s, Il-Arslan annexed Dehistan and the surrounding area to the possessions of Khorezm. He managed to subjugate several cities of Khorasan, he tried to subjugate part of the cities of the Iraqi Sultanate, Transoxiana. In 1172, he successfully repelled the Karakitai campaign against Khorezm. Soon after this, Il-Arslan died, and his sons Alaad-Din Tekeshand Jalal ad-Din Sultan Shah began to fight for the throne',
				history_ru:
					'Тадж ад-Дин Иль-Арслан (полное имя — Тадж ад-Дунийава-д-Дин Абу-л-Фатх Иль Арслан ибн Атсыз; умер 7 марта 1172) - Хорезмшах, сын Хорезмшаха Ала ад-Дина Атсыза из династии Ануштегенидов. Правил с 1156 по 1172 годы. Прозвище Иль Арслан, в переводе с тюркского означает - лев народа. В 1152 году Иль-Арслан стал правителем города Дженда, завоёванного его отцом в нижнем течении Сырдарьи. В 1156 году, после смерти шаха Атсыза, Иль-Арслан вступил на престол Хорезма. Как и отец, он не платил дань Cельджукскому султану Санджару и Каракитаям. Всего через несколько месяцев после прихода Иль-Арслана к власти, в 1157 году, Санджар умер, что позволило Хорезму полностью освободиться от Сельджукского влияния. В 1160-х годах Иль-Арслан присоединил к владениям Хорезма Дехистан с окрестностями. Ему удалось подчинить несколько городов Хорасана, он пытался подчинить себе часть городов Иракского султаната, Мавераннахра. В 1172 году он успешно отразил поход Каракитаев на Хорезм. Вскоре после этого Иль-Арслан умер, а его сыновья Ала ад-Дин Текеш и Джелал ад-Дин Султан-шах начали борьбу за престол',
			},
			{
				id: uuidv4(),
			...
			},
			{
				...
				history:
					'One of the few surviving monuments of pre-Mongol Urgench - the mausoleum of Khorezmshah Tekesh (Sultan-Tekesh) - was built in 1220 according to the type of tombs that was then very common in Khorezm. This is the mausoleum of the ruler of Gurganj - Tekesh, who died in 1200. Khorezmshah Tekesh was a very odious person, he managed to unite a huge territory, stretching from the Aral Sea in the north to the Persian Gulf in the south and from the Pamirs in the east to the Iranian Plateau in the west. In 1172, in order to take the throne, he turned to his former enemies - the Karakitai - for help, who agreed in exchange for an annual tribute help him overthrow his brother from the throne, and then, having already received power over Khorezm, he ordered the death of his mother. The mausoleum of Khorezmshah Tekesh once towered over the city to a height of 30 meters and was a kind of beacon in the desert. Weary travelers wandering through the hot desert saw him from afar and thus received a signal to end the difficult journey',
				history_ru:
	...
	},
	{
		...
		places: [
			...
			},
			{
				...
				img: Karakum,
				history:
					'The Karakum desert is a sandy desert, one of the largest in Central Asia, one of the largest on earth. It occupies almost 3/4 of the territory of the Republic of Turkmenistan. It is located between the foothills of Kopetdag, Karabil and Vankhyz in the south, the Khorezm lowland in the north, the Amu Darya valley in the east and the bed of the Western Uzboy in the west. The length of the Karakum along the parallel is about 800km, along the meridian - about 450km, the total area is more than 350 thousand sq.km. It exceeds the territory of states such as Great Britain, Italy or Norway',
				history_ru:
					'Каракумы – это песчаная пустыня, одна из самых больших в Центральной Азии, одна из крупных на земле. Она занимает почти 3/4 территории Республики Туркменистан. Расположена между предгорьями Копетдага, Карабиля и Ванхыза на юге, Хорезмской низменностью на севере, долиной Амударьи на востоке и руслом Западного Узбоя на западе. Протяженность Каракумов по параллели – около 800 км, по меридиану – около 450 км, общая площадь – более 350 тыс.кв.км. Она превышает территорию таких государств, как Великобритания, Италия или Норвегия',
			},
			{
				id: uuidv4(),
				name: 'Parau-bibi',
			...
			},
			{
				...
				img: GozliAta,
				history:
					'Gozli-ata Mausoleum is located in the Balkan region in western Turkmenistan. Located 157 kilometers from Turkmenbashi. The Mausoleum of Gozli Ata is the most remote place of pilgrimage in Turkmenistan. The mausoleum is located in a picturesque place, surrounded by pink, greenish, reddish mountains of amazing shape and beauty. On these lands, Turkmen warriors courageously defended themselves against the troops of the Khiva Khan, gradually increasing their independence. At the mausoleum and the grave of the saint, rites are held, legends are pronounced about the great commander, after whom this place is named. Gozli-ata, or Uzynkhasan - a mystical personality and spiritual leader of the Balkan Turkmen tribes during the Middle Ages',
				history_ru:
					'Гозли-ата Мавзолей находится в Балканском велаяте на западе Туркменистана. Расположен в 157 километрах от Туркменбаши. Мавзолей Гозли Ата – самое отдаленное место паломничества в Туркменистане. Мавзолей находится в живописном месте, окруженным розовыми, зеленоватыми, красноватыми горами удивительной формы и красоты. На этих землях мужественно оборонялись туркменские воины от войск Хивинской ханы, постепенно усиливая свою независимость. У мавзолея и могилы святого проходят обряды, произносятся легенды о великом полководце, именем которого названо это место. Гозли-Ата, или Узынхасан — мистическая личность и духовный лидер прибалканских туркменских племен в период средневековья',
			},
		],
	},
]
